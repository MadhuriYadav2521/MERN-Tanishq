    ...
    return (
        <div>
            <div class="admin-panel-navbar">
                ...
                <div class="admin-top-menu-wrapper">
                    <div class="menu">
                        <a href="">
                            <div class="menu-img">
                    ...
                    <div class="menu">
                        <a href="./signup.html">
                            <div class="menu-img">
                                <Icon.ListCheck className="bIcon" />

                            </div>
                            <div class="menu-title" id="switch">content</div>
                        </a>
                    </div>
                    <div class="menu">
                        <a href="">
                            <div class="menu-img">
                                <Icon.Postcard className="bIcon" />
                    ...
                    <div class="menu">
                        <a >
                            <div class="menu-img">
                                <Icon.ListColumns className="bIcon" />
