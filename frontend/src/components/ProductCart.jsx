        ...
        <div>
            ...
            <div classNameName="screen">
                ...
                {cart?.length ? (
                                        ...
                                        <div className="cart-products" key={p._id}>
                                            ...
                                            <div className="cart-product-details" >
                                                ...
                                                <div className="cart-price-section">
                                                    ...
                                                    <div className="cart-del-price"><del>₹ 26019</del></div>
                                                </div>
                                    ...
                                    <div className="cart-billing-details">
                                        ...
                                        <div className="order-summary">
                                            ...
                                            <div className="billing-content">
                                                ...
                                                <div className="bill-right">2000</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div>
                        <div className="container-header" style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
